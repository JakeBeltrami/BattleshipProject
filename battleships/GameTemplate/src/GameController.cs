...
{
    private static BattleShipsGame theGame;
    private static Player human;
    private static AIPlayer ai;

    private static Stack<GameState> _state = new Stack<GameState>();

    private static AIOption aiSetting;
    ...
    public static void StartGame()
    {
        ...
        human = new Player(theGame);

        // AddHandler _human.PlayerGrid.Changed, AddressOf GridChanged
        ai.PlayerGrid.Changed += GridChanged;
        theGame.AttackCompleted += AttackCompleted;
    ...
    {
        bool isHuman;
        isHuman = theGame.Player == HumanPlayer;
    ...
    {
        // deploy the players
        theGame.AddDeployedPlayer(human);
        theGame.AddDeployedPlayer(ai);
    ...
    private static void CheckAttackResult(AttackResult result)
    {
        switch (result.Value)
        {
            case object _ when ResultOfAttack.Miss:
                {
                    if (theGame.Player == ComputerPlayer)
                        AIAttack();
                    break;
                }
